  ...
  return (
    <div className="App">
       ...
       <meta property="og:url" content={`super ${window.location.href}`} />
                ...
                { window.location.href === "https://5fc01b589e5cc60009962bf8--tender-aryabhata-7440aa.netlify.app/" && <meta property="og:image" content="http://static01.nyt.com/images/2015/02/19/arts/international/19iht-btnumbers19A/19iht-btnumbers19A-facebookJumbo-v2.jpg" />}
            </Helmet>
